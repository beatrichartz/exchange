...
describe "Exchange::Cache::Memory" do
  ...
  describe "clean_out_cache" do
    before(:each) do
      ...
      subject.instance_variable_set '@exchange_externalapi_currencybot_2010_280_8_2012_284_8', 'Expired'
    ...
    it "should unset all expired instance variables" do
      subject.send(:clean!)
      subject.instance_variables.map{|i| subject.instance_variable_get(i) }.compact.should == %W(Valid1 Valid2 Valid3 Valid4)
    end
  end
  describe "cached" do
