...
Since The Currency Bot API, now renamed to Open Exchange Rates API at openexchangerates.org, requires an APP ID now, you should configure it using the Exchange::Configuration

  Exchange::Configuration.define do |c|
    c.api_app_id = 'YOUR_APP_ID0
  end
