...
== Caution! Do not use with MRI 2.1.0-p0
MRI 2.1.0-p0 has {a confirmed bug in BigDecimal causing it to return wrong results for BigDecimal division.}[https://www.ruby-forum.com/topic/4419577] You'll see in the travis test results that several specs are failing for this gem with MRI 2.1.0-p0. All 2.0 versions work fine though.
