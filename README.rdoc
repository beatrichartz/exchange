= exchange {<img src="https://secure.travis-ci.org/beatrichartz/exchange.png" />}[http://travis-ci.org/beatrichartz/exchange] {<img src="https://codeclimate.com/badge.png" />}[https://codeclimate.com/github/beatrichartz/exchange]
...
- Some structurally unsound behaviour with ruby base operators (+, -, *, /) has been corrected. It is recommended to update to this latest version of exchange if you are using a version less than 0.7. 
