...
The Exchange Gem gives you easy access to currency functions directly on your Numbers. It has been tested against ruby 1.8.7, ree, ruby 1.9.2 and 1.9.3 and rubinius in 1.9 and 1.8 mode (see travis link for details). You can use it with just plain ruby projects, in Rails 2 and 3, Sinatra or whatever Framework you like.
...
but if you have another API you like to use, it becomes as easy as writing one Class and two methods to use it. Visit the documentation here: http://rubydoc.info/github/beatrichartz/exchange/Exchange/ExternalAPI to see an example of a custom API Extension
...
But, same here, if you don't like any of these or want to use your own caching solution, it is as easy as writing one Class and two methods to use it. Just visit the documentation here: http://rubydoc.info/github/beatrichartz/exchange/Exchange/Cache for an example of a cache extension
