...
The Exchange Gem gives you easy access to currency functions directly on your Numbers. {It has been tested against}[http://travis-ci.org/beatrichartz/exchange]: 
- ruby 1.9.3
- ruby 1.9.2
- ruby 1.8.7
- ree
- rubinius in 1.9 mode 
- rubinius in 1.8 mode 
- jruby 
