...
=== Production Ready
Exchange is production-ready. It is in use on {rightclearing.com}[http://rightclearing.com], a music licensing service worth noticing. If you use this gem in production, {drop a note}[beat.richartz@gmail.com] so your app can be listed here.
